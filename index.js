...
var formatServerErrors = function formatServerErrors(errors) {
  ...
  errors.forEach(function (error) {
    ...
    if (result[name]) {
      result[name] = (0, _lodash.join)([result[name], reason], ', ');
    } else {
      result[name] = reason;
    }
  });
...
var formatErrorResponse = exports.formatErrorResponse = function formatErrorResponse(errorResponse) {
  var errors = (0, _lodash.get)(errorResponse, 'message.errors') || [];

  return _extends({}, formatServerErrors(errors), {
...
var BaseConfig = function () {
  ...
  _createClass(BaseConfig, [{
    key: 'allActions',
    value: function allActions() {
      var TYPES = BaseConfig.TYPES;
      ...
      }, this._genericActions(TYPES.CREATE), this._genericActions(TYPES.DESTROY), this._genericActions(TYPES.LOAD), this._genericActions(TYPES.UPDATE));
    }
  }, {
    key: 'successAction',
    value: function successAction(apiResponse, thunk) {
      ...
      var parsable = (0, _lodash.isArray)(response) ? response : [response];
      var parsed = _parse(parsable);

      var _normalize = (0, _normalizr.normalize)(parsed, [schema]),
    ...
    key: '_apiCallForType',
    value: function _apiCallForType(type) {
      var TYPES = BaseConfig.TYPES;
    ...
    key: '_genericActions',
    value: function _genericActions(type) {
      var _ref;
      ...
      var capitalType = (0, _lodash.capitalize)(type);

      return _ref = {}, _defineProperty(_ref, lowerType, this._genericThunkAction(type)), _defineProperty(_ref, 'silent' + capitalType, this._genericThunkAction(type, { silent: true })), _defineProperty(_ref, lowerType + 'Request', this._genericRequest(type)), _defineProperty(_ref, lowerType + 'Success', this._genericSuccess(type)), _defineProperty(_ref, lowerType + 'Failure', this._genericFailure(type)), _ref;
    }
  }, {
    key: '_genericThunkAction',
    value: function _genericThunkAction(type) {
      var _this = this;

      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      var apiCall = this._apiCallForType(type);
      ...
      return function () {
        ...
        return function (dispatch) {
          if (!options.silent) {
            dispatch(_this._genericRequest(type)());
          }

          return apiCall.apply(undefined, args).then(function (response) {
            var thunk = _this._genericSuccess(type);

            dispatch(_this.successAction(response, thunk));

            return response;
          }).catch(function (response) {
            var thunk = _this._genericFailure(type);
            var errorsObject = (0, _helpers.formatErrorResponse)(response);
    ...
    key: '_genericRequest',
    value: function _genericRequest(type) {
      var _this2 = this;
      ...
      switch (type) {
        case TYPES.CREATE:
          return function () {
            return { type: _this2.actionTypes.CREATE_REQUEST };
          };
        case TYPES.DESTROY:
          return function () {
            return { type: _this2.actionTypes.DESTROY_REQUEST };
          };
        case TYPES.LOAD:
        case TYPES.LOAD_ALL:
          return function () {
            return { type: _this2.actionTypes.LOAD_REQUEST };
          };
        case TYPES.UPDATE:
          return function () {
            return { type: _this2.actionTypes.UPDATE_REQUEST };
          };
        default:
    ...
    key: '_genericSuccess',
    value: function _genericSuccess(type) {
    ...
    key: '_genericFailure',
    value: function _genericFailure(type) {
      var actionTypes = this.actionTypes;
    ...
    value: function _parse(response) {
      var result = response;
      var parseApiResponseFunc = this.parseApiResponseFunc,
          parseEntityFunc = this.parseEntityFunc;
    ...
    key: 'failureActionTypeFor',
    value: function failureActionTypeFor(actionTypes, type) {
      var TYPES = BaseConfig.TYPES;
    ...
    key: 'successActionTypeFor',
    value: function successActionTypeFor(actionTypes, type) {
      var TYPES = BaseConfig.TYPES;
